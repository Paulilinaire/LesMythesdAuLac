...
public class SorcererBonusCapacity extends BonusCapacity {
    ...
    public static class Builder {
        ...
        public BonusCapacity build() {
            ...
            return new SorcererBonusCapacity(this);
        }
    }
}
