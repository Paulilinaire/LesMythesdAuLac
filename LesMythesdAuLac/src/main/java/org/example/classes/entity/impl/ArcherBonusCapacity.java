...
public class ArcherBonusCapacity extends BonusCapacity {
    private String capacityBonusName;
    private boolean acquired;
    private String capacityLevel;

    private ArcherBonusCapacity(Builder builder){
    ...
    public static class Builder {
        ...
        public BonusCapacity build() {
            ...
            return new ArcherBonusCapacity(this);
        }
